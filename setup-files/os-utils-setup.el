...
(use-package prodigy
  ...
  (prodigy-define-service
    :name "Farm-Focus Mobile App"
    :cwd "~/github/farm-focus/mobile-app/src"
    :command "tns"
    :args '("debug" "android")
    :stop-signal 'int
    :tags '(FarmFocus)
  ...
  (prodigy-define-service
    :name "Farm-Focus Backend"
    :cwd "~/github/farm-focus/back-end-api"
    :ready-message "Server running on"
    :command "npm"
    :args '("run" "start:dev")
    :tags '(FarmFocus)
    :stop-signal 'int
  ...
  (prodigy-define-service
    :name "Farm-Focus Frontend"
    :cwd "~/github/farm-focus/front-end-client"
  ...
  (prodigy-define-service
    :name "Farm-Focus Camera Client"
    :cwd "~/github/farm-focus/camera-api"
    :ready-message "Client started"
    :command "npm"
    :args '("run" "start:dev")
    :tags '(FarmFocus)
    :stop-signal 'int
