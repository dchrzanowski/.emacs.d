...
(custom-set-variables
 ...
 '(company-backends
   '(company-bbdb company-semantic company-clang company-cmake company-capf company-files
                  (company-dabbrev-code company-keywords company-web-html company-etags company-gtags)
                  company-oddmuse))
 ...
 '(package-selected-packages
   '(lua-mode hledger-input ox-json binky slime eldoc-box evil-snipe eshell-syntax-highlighting magit-delta zeal-at-point company-box org-rainbow-tags separedit csv-mode tree-sitter helm-firefox jq-mode evil-vimish-fold telega company-php evil-mc ledger-mode evil-org gnuplot-mode gnuplot rustic flutter dart-mode org-superstar password-generator helm-org-rifle bookmark+ ess engine-mode org-fancy-priorities highlight-numbers mu4e-maildirs-extension mu4e-alert mu4e org-mime python-mode typescript treemacs-evil go-mode nginx-mode dired-hide-dotfiles quelpa-use-package quelpa which-key-posframe electric-operator helm-posframe helm-chronos chronos pcmpl-args git-link expand-region disk-usage company-restclient helm-chrome doom-modeline all-the-icons-dired ob-mongo keychain-environment exec-path-from-shell company-tern tern kv a yaml-mode dockerfile-mode moody minions multifiles define-word smart-jump highlight-thing speeddating use-package-ensure-system-package zerodark-theme ranger vlf vlfi org-super-agenda org-kanban org-edna gitattributes-mode gitconfig-mode dired-subtree dired-filter dired-ranger helm-google helm-gitignore flx fzf ibuffer-vc helpful color-identifiers-mode darkroom org-notify org-alert toc-org org-projectile org-download diredful direful evil-colletion general company-statistics json-mode jedi virtualenv holiday holidays pdf-tools calfw-org calfw zenity-color-picker helm-system-packages exato evil-indent-plus evil-number evil-exchange ace-link git-messenger omnisharp-emacs markdown-mode notmuch js-doc dired-du web-beautify doom-themes restclient evil-nerd-commenter eyebrowse emmet-mode emmet ox-reveal ox-impress-js org-impress-js ox-gfm org-brain company-ispell imenu-anywhere pomidor company-yasnippet eclimd evil-lion git-gutter-fringe git-timemachine lice dired-launch auto-yasnippet quickrun evil-magit evil-god-state god-mode evil-args evil-visualstar evil-anzu evil-surround evil-leader powerline-evil powerline latex-extra tabbar rainbow-mode rainbow-delimiters org-bullets helm-swoop company-web company-jedi auto-package-update anaphora ac-html-bootstrap ac-dabbrev undo-tree))
